...
public interface PostgreSQLParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link PostgreSQLParser#create_schema_role_spec}.
	 * @param ctx the parse tree
	 */
	void enterCreate_schema_role_spec(PostgreSQLParser.Create_schema_role_specContext ctx);
	/**
	 * Exit a parse tree produced by {@link PostgreSQLParser#create_schema_role_spec}.
	 * @param ctx the parse tree
	 */
	void exitCreate_schema_role_spec(PostgreSQLParser.Create_schema_role_specContext ctx);
	/**
